...
|--------------------------------------------------------------------------
| Estas rutas son SOLO para mostrar la pantalla final.
| El estado real lo define el webhook.
*/
...
/*
|--------------------------------------------------------------------------
| WEBHOOK MERCADO PAGO (FUENTE DE VERDAD)
|--------------------------------------------------------------------------
*/
...
Route::get('/transferencia/{order}', [TransferController::class, 'show'])
    ->name('transfer.instructions');

Route::post('/transferencia/{order}/proof', [TransferController::class, 'uploadProof'])
    ->name('transfer.proof');

Route::post('/transferencia/{order}/confirmar', [TransferController::class, 'confirm'])
    ->name('transfer.confirm');

Route::get('/transferencia/{order}/gracias', [TransferController::class, 'thanks'])
    ->name('transfer.thanks');