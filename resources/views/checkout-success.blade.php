<x-layouts.app title="Pago | Todo Artesanal Tuxtla">
    <div class="max-w-xl mx-auto bg-white/85 backdrop-blur rounded-2xl border shadow p-8 text-center">
        ...
        <div class="mt-4 rounded-2xl border bg-white p-4 text-left">
            ...
            <p class="font-black">{{ is_object($order->status) ? $order->status->value : $order->status }}</p>
        ...
        <p class="mt-4 text-sm text-slate-600">
            Nota: El estado final se confirma automáticamente cuando Mercado Pago notifica por webhook.
        </p>
